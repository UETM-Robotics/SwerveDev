...
public class RobotConstants {
    ...
    public static final double wheelBase = 0.667;
    ...
    public static final PIDFConstants swerveAnglePID = new PIDFConstants(0.001, 0, 0);

    //Angle Offsets for the Swerve CANcoder offsets
    public static final double swerveModuleAngleOffsetFL = 0.39 * 360;
    public static final double swerveModuleAngleOffsetFR = 0.251 * 360;
    public static final double swerveModuleAngleOffsetHL = -0.234 * 360;
    public static final double swerveModuleAngleOffsetHR = -0.05 * 360;
